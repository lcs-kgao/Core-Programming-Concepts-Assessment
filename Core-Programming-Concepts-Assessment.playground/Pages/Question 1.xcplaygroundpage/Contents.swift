...
let temperatureInCelsium : Double = 20
let temperatureInFahrenheit = temperatureInCelsium * 9 / 5 + 32
print("A temperature in degrees Celsius of \(temperatureInCelsium) is equal to \(temperatureInFahrenheit) in degrees Fahrenheit.")
